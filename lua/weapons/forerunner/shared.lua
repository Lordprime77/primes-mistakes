...
SWEP.Manufacturer               = "some jackass in the halo universe" -- Gun Manufactrer (e.g. Hoeckler and Koch)
SWEP.Author                     = "prime" -- Author Tooltip
SWEP.Contact                    = "master chef?" -- Contact Info Tooltip
SWEP.Purpose                    = "pop" -- Purpose Tooltip
SWEP.Instructions               = "aim stupid" -- Instructions Tooltip
...
SWEP.PrintName                  = "Magnum"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound              = Sound("weapons/magnum/gunfire/magnum_shoot.wav") -- This is the sound of the weapon, when you shoot.
...
----------------- ViewModel related
SWEP.ViewModel          = "models/weapons/v_forerunnermcc.mdl" -- Viewmodel path
...
-- AKA CrouchPos
SWEP.CrouchViewModelPosition    = Vector(-9.54, -0.603, 1.48) -- Defaults to nothing, use Vector(0, 0, 0) as starting point
-- AKA CrouchAng
...
----------------- Worldmodel related
SWEP.WorldModel                 = "models/weapons/w_forerunnermcc.mdl" -- Weapon world model path
-- AKA Bodygroups_W
