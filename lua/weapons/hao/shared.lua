...
SWEP.Purpose                    = "do seve deh mister chef" -- Purpose Tooltip
SWEP.Instructions               = "balls, balls, balls" -- Instructions Tooltip
...
SWEP.PrintName                  = "Hao Rifle"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound              = Sound("weapons/rifle/rifle_fire_1.wav") -- This is the sound of the weapon, when you shoot.
...
----------------- ViewModel related
SWEP.ViewModel          = "models/weapons/v_hao.mdl" -- Viewmodel path
...
----------------- Worldmodel related
SWEP.WorldModel                 = "models/weapons/w_hao.mdl" -- Weapon world model path
-- AKA Bodygroups_W
