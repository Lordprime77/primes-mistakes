...
SWEP.Contact                    = "fuck off" -- Contact Info Tooltip
SWEP.Purpose                    = "die" -- Purpose Tooltip
SWEP.Instructions               = "yes" -- Instructions Tooltip
...
SWEP.PrintName                  = "TFA WTF"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage             = 9000 -- Damage, in standard damage points.
...
SWEP.Primary.Sound              = Sound("weapons/awp/gunfire/awp1.wav") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound      = nil -- This is the sound of the weapon, when silenced.
-- AKA IronInSound
SWEP.Secondary.IronSightsInSound = Sound("weapons/awp/gunother/zoom.wav") -- Sound to play when iron sighting in? nil for default
-- AKA IronOutSound
...
SWEP.Primary.PenetrationPower           = 10 -- Defaults to autodetect
...
SWEP.Primary.PenetrationMultiplier      = 10 -- Defaults to 1
...
----------------- ViewModel related
SWEP.ViewModel          = "models/weapons/v_wtf.mdl" -- Viewmodel path
...
SWEP.SprintViewModelPosition    = Vector(3.58, -20, -10.86) -- Change this, using SWEP Creation Kit preferably
-- AKA RunSightsAng (SWEP Construction Kit naming)
SWEP.SprintViewModelAngle       = Vector(70, 0, -10.553) -- Change this, using SWEP Creation Kit preferably

-- Position when crouching
-- Viewmodel offset when player is crouched
-- AKA CrouchPos
SWEP.CrouchViewModelPosition    = Vector(-8.643, 3.819, -1.00) -- Defaults to nothing, use Vector(0, 0, 0) as starting point
-- AKA CrouchAng
SWEP.CrouchViewModelAngle       = Vector(0, 0, -54) -- Defaults to nothing, use Vector(0, 0, 0) as starting point
...
----------------- Worldmodel related
SWEP.WorldModel                 = "models/weapons/w_wtf.mdl" -- Weapon world model path
-- AKA Bodygroups_W
