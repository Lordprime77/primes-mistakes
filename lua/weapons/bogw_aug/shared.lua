...
SWEP.Purpose                    = "for the gamer vs furry war" -- Purpose Tooltip
SWEP.Instructions               = "kill shit stupid" -- Instructions Tooltip
...
SWEP.PrintName                  = "Call of Duty Black Ops Gamer Wars AUG"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM                = 937.5 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.Sound              = Sound("weapons/aug/aug-1.wav") -- This is the sound of the weapon, when you shoot.
...
----------------- ViewModel related
SWEP.ViewModel          = "models/weapons/v_bogw_aug.mdl" -- Viewmodel path
...
SWEP.IronSightsPosition         = Vector(-5.226, -6.633, 0.603) -- Change this, using SWEP Creation Kit preferably
...
----------------- Worldmodel related
SWEP.WorldModel                 = "models/weapons/w_bogw_aug.mdl" -- Weapon world model path
-- AKA Bodygroups_W
